...
class YOLO(object):
    ...
    '''
    def __init__(self):
        self.model_path = 'vision/data/model.h5' # model path or trained weights path
        self.anchors_path = 'vision/data/anchors.txt'
        self.classes_path = 'vision/data/classes.txt'
        self.score = 0.3
        self.iou = 0.45
    ...
    def detect_image(self, image):
        ...
        print('Time consumed for target detecting: {}'.format(end - start))
